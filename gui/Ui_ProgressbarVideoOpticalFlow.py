...
class Ui_ProgressDialogVideoOpticalFlow(object):
    def setupUi(self, ProgressDialogVideoOpticalFlow):
        ...
        self.opticalFlowBar = QtWidgets.QProgressBar(self.groupBox)
        self.opticalFlowBar.setProperty("value", 24)
        self.opticalFlowBar.setObjectName("opticalFlowBar")
        self.gridLayout_2.addWidget(self.opticalFlowBar, 0, 3, 1, 1)
