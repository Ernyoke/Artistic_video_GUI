...
\subsubsection{A beállítások (Settings) komponens  bemutatása}
...
\subsubsection{A progress sáv (Progress bar) komponens bemutatása}

\begin{figure}[!htbp]
	\begin{center}
		\includegraphics[scale=0.7]{progressbar.png}
		\caption{Progressbar}
