...
\begin{document}
	...
	\begin{frame}
		\frametitle{Eredmény képek}
		\begin{figure}[!htbp]
			\centering
			\subfloat[Eredit kép]{
				\includegraphics[width=25mm]{stylistic/original/sapientia.jpg}
			}
			\subfloat[Stíluskép]{
				\includegraphics[width=25mm]{stylistic/styles/csontvary_kosztka_tivadar_traui_tajkep_naplemente_idejen.jpg}
			}
			\subfloat[Eredmény]{
				\includegraphics[width=25mm]{stylistic/place/csontvary.jpg}
			}
		...
		\begin{figure}[!htbp]
			\centering
			\subfloat[Eredeti kép]{
				\includegraphics[width=25mm]{stylistic/original/sapientia.jpg}
			}
			\subfloat[Stíluskép]{
				\includegraphics[width=25mm]{stylistic/styles/munkacsi_mihaly_vihar_a_pusztan.jpg}
			}
			\subfloat[Eredmény]{
				\includegraphics[width=25mm]{stylistic/place/munkacsi.jpg}
			}
	...
	\begin{frame}
		...
		\framesubtitle{Naiv megközelítés}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item Az elöző stilizált képkockát torzítjuk az optical flow vektorai szerint
		\end{itemize}
	\end{frame}
